  ...
  \code{.xml}
    <plugin name="plugin_name" filename="libgazebo_ros_depth_camera.so">
      ...
      <ros>
        ...
        <argument>custom_camera/image_depth:=custom_camera/custom_depth_image</argument>
        <argument>custom_camera/camera_info_raw:=custom_camera/raw_custom_info</argument>
        <argument>custom_camera/camera_info_depth:=custom_camera/depth_custom_info</argument>
